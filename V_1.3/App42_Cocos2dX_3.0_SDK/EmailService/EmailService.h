...
public:
    ...
    void createMailConfiguration(string emailHost, int emailPort,string mailId, string emailPassword, bool isSSL,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void removeEmailConfiguration(string emailId,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void getEmailConfigurations(App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    void sendMail(string sendTo, string sendSubject, string sendMsg,string fromEmail, EmailMIME emailMIME,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
};

...
void EmailService::createMailConfiguration(string emailHost, int emailPort,string emailId, string emailPassword, bool isSSL,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
     ...
     */
    Util::executePost(encodedUrl, headers, createMailConfigurationbody.c_str(), response, httpresponse_selector(App42UserResponse::onComplete));
    
}

void EmailService::removeEmailConfiguration(string emailId,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42EmailResponse *response = new App42EmailResponse::App42EmailResponse(pTarget,pSelector);
     ...
     * Initiating Http call
     */
    Util::executeDelete(encodedUrl, headers, response, httpresponse_selector(App42UserResponse::onComplete));
...
void EmailService::sendMail(string sendTo, string sendSubject, string sendMsg,string fromEmail, EmailMIME emailMIME,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42EmailResponse *response = new App42EmailResponse::App42EmailResponse(pTarget,pSelector);
     ...
     * Initiating Http call
     */
    Util::executePost(encodedUrl, headers, sendMailbody.c_str(), response, httpresponse_selector(App42UserResponse::onComplete));

...
namespace Util
{
    ...
    static void executePost(string baseUrl,std::vector<std::string> headers, const char* postData,Ref* pTarget, cocos2d::network::SEL_HttpResponse pSelector)
    {
    ...
    static void executePut(string baseUrl,std::vector<std::string> headers, const char* postData,Ref* pTarget, cocos2d::network::SEL_HttpResponse pSelector)
    {
        cocos2d::network::HttpRequest* request = new cocos2d::network::HttpRequest();
        request->setUrl(baseUrl.c_str());
        request->setRequestType(cocos2d::network::HttpRequest::Type::POST);
...
//        app42Trace("\nBaseURL=%s",baseUrl.c_str());
    ...
    static void executeGet(string baseUrl,std::vector<std::string> headers,Ref* pTarget, cocos2d::network::SEL_HttpResponse pSelector)
    {
        cocos2d::network::HttpRequest* request = new cocos2d::network::HttpRequest();
        request->setUrl(baseUrl.c_str());
    ...
    static void executeDelete(string baseUrl,std::vector<std::string> headers,Ref* pTarget, cocos2d::network::SEL_HttpResponse pSelector)
    {
        cocos2d::network::HttpRequest* request = new cocos2d::network::HttpRequest();
        request->setUrl(baseUrl.c_str());
        request->setRequestType(cocos2d::network::HttpRequest::Type::GET);

...
public:
     ...
     *
     */
	void SaveUserScore(string gameName,string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void EditScoreValueById(string scoreId, double gameScore, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
	void GetAverageScoreByUser(string gameName, string userName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
	void GetHighestScoreByUser(string gameName,string userName , App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
	void GetLastScoreByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     *
     */
	void GetTopRankings(string gameName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     *
     */
	void GetUserRanking(string gameName, string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetTopNRankers(string gameName,int max,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    ...
    void GetScoresByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetLowestScoreByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
    void GetTopRankersByGroup(string gameName,std::vector<std::string>group,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    ...
    void GetLastGameScore(string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
    
    void GetTopNTargetRankers(string gameName,int max,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);

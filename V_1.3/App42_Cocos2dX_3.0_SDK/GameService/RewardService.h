...
public:
     ...
     *
     */
	void CreateReward(string rewardName,string description, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     *
     */
	void EarnRewards(string gameName, string userName, string rewardName, double rewardPoints,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     *
     */
	void RedeemRewards(string gameName, string userName, string rewardName, double rewardPoints,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     * 
     */
	void GetGameRewardPointsForUser(string gameName, string userName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
};

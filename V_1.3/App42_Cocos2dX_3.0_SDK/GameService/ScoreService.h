...
public:
	...
	void AddScore(string gameName, string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
	/**
     ...
     *
     */
	void DeductScore(string gameName, string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);

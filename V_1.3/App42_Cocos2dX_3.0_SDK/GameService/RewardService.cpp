...
void RewardService::EarnRewards(string gameName, string userName, string rewardName, double rewardPoints,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);
...
void RewardService::RedeemRewards(string gameName, string userName, string rewardName, double rewardPoints,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);

...
void ScoreService::AddScore(string gameName, string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
...
void ScoreService::DeductScore(string gameName, string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);

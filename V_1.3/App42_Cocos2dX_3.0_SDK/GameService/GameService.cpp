...
void GameService::CreateGame(string gameName,string description, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
...
void GameService::GetGamebyName(string gameName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);

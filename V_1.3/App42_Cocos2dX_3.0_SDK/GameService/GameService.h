...
public:
     ...
     *
     */
	void CreateGame(string gameName,string description, App42CallBack* pTarget, SEL_App42CallFuncND pSelector);
     ...
     *
     */
	void GetGamebyName(string gameName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector);

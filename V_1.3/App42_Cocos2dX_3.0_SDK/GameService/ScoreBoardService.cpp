...
void ScoreBoardService::SaveUserScore(string gameName,string userName, double score, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
...
void ScoreBoardService::EditScoreValueById(string scoreId, double gameScore, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetAverageScoreByUser(string gameName, string userName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
...
void ScoreBoardService::GetHighestScoreByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetLastScoreByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopRankings(string gameName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopNRankers(string gameName,int max,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetUserRanking(string gameName, string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetScoresByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
...
void ScoreBoardService::GetLowestScoreByUser(string gameName,string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopRankersByGroup(string gameName,std::vector<std::string>group,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetLastGameScore(string userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopNTargetRankers(string gameName,int max,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
